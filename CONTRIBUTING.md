# Contributing to universal serialize
...
```bash
# Clone it
$ git clone git@github.com:krakenjs/universal-serialize.git

# Change directory
$ cd universal-serialize

# Add the upstream repo
$ git remote add upstream git://github.com/krakenjs/universal.git
